...
address:
  - code: a
    address: Debian and R Projects; Chicago, IL, USA; \code{edd@debian.org}
  - code: b
    address: Depts of Informatics and Statistics, Univ. of Illinois at Urbana-Champaign; Champaign, IL, USA; \code{balamut2@illinois.edu}
